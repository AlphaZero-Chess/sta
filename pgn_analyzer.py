...
def main():
    ...
    # Karpov added for legendary positional mastery
    pgn_files = [
        ('alphazero_stockfish_2017.pgn', 'AlphaZero', 3.5),
        ('alphazero_stockfish_2017 (1).pgn', 'AlphaZero', 3.5),
        ('alphazero_stockfish_2017 (2).pgn', 'AlphaZero', 3.5),
        ('alphazero_stockfish_2017 (3).pgn', 'AlphaZero', 3.5),
        ('alphazero_stockfish_2017 (4).pgn', 'AlphaZero', 3.5),
        ('alphazero_stockfish_2018 (2).pgn', 'AlphaZero', 3.5),
        ('alphazero_stockfish_2018 (3).pgn', 'AlphaZero', 3.5),
        ('alphazero_stockfish_2018 (4).pgn', 'AlphaZero', 3.5),
        ('alphazero_stockfish_2018 (5).pgn', 'AlphaZero', 3.5),
        ('alphazero_stockfish_2018 (6).pgn', 'AlphaZero', 3.5),
        ('Fischer.pgn', 'Bobby Fischer', 3.0),
        ('Karpov.pgn', 'Anatoly Karpov', 2.5),
        ('Carlsen.pgn', 'Magnus Carlsen', 2.2),
        ('Morphy.pgn', 'Paul Morphy', 2.2),
    ]
    ...
    output = {
        'metadata': {
            ...
            'masters': ['AlphaZero', 'Bobby Fischer', 'Anatoly Karpov', 'Magnus Carlsen', 'Paul Morphy'],
            'statistics': stats
        },
